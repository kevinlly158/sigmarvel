...
{
    resize(850, 550);
    setWindowTitle(tr("Sigmarvel") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Sigmarvel address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Sigmarvel"), this);
    aboutAction->setToolTip(tr("Show information about Sigmarvel"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Sigmarvel"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Sigmarvel client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Sigmarvel client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sigmarvel network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Sigmarvel address or malformed URI parameters."));
    }
